...
public:
	...
	void randomInit(uchar* image, double timeStamp, int id, uchar** imageBGR, uchar* gradMask);
	void gtDepthInit(uchar* image, float* depth, double timeStamp, int id, uchar** imageBGR);
